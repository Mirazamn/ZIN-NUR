...
import '../variable.css'
import '../../index.css'
import { Sergeli, Uchtepa, Yunusobod } from '../../assets/plan'
    ...
    return(
        <div className="branches">
            <div className="container flex">
                    ...
                    <div data-aos="fade-down-left" className="card yunusobod">
                        <div className="branch-txt">
                            <h2>YUNUSOBOD FILIALI</h2>
                            <a href='https://yandex.uz/maps/org/zin_nur_akademiyasi/155272257265/?ll=69.210049%2C41.220986&z=16.77' target='_blank'>
                                Sergeli-VII, 29A, Toshkent
                            </a>
                        </div>
                        <img src={Yunusobod} className="uchtepa column" />
                    </div>
            </div>
        </div>
    )
